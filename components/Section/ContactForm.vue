<template>
  <div class="flex flex-col items-center gap-8">
    ...
    <a href="mailto:hello@world-wide.dev" class="flex text-lg text-gray-400/90">
      hello@world-wide.dev
    </a>
    ...
    <div>
      <form
        class="text-content flex w-full flex-col justify-center gap-8 rounded-xl"
