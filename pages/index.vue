<template>
  ...
  >
    <div class="order-0 mb-4 lg:mb-0">
      <Photo />
    </div>
    <div class="space-y-5 text-center lg:text-left">
      ...
      <p class="max-w-[500px] text-white/80">
        I’m a software developer from Germany, focused on crafting top-tier
        frontend solutions.
      </p>
      <Stack size="sm" class="max-w-[500px] justify-center lg:justify-start" />
      <div
        class="flex flex-col items-center justify-center gap-8 lg:flex-row lg:justify-start"
      >
        <a href="mailto:hello@world-wide.dev" class="btn-lg uppercase">
          Hire Me
        </a>
...
const socials = [
  {
    icon: "linkedin",
    path: "https://www.linkedin.com/in/thomas-lallinger-b3a116117/",
  },
